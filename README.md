...
**Grafana Admin Username & Password** can be customized in the variables `grafana_admin_user` & `grafana_admin_pwd` (file [root.hcl](https://github.com/lesposito87/poorman-aws-playground/blob/main/root.hcl)).
...
**Harbor Admin Password** can be customized in the variable `harbor_admin_pwd` (file [root.hcl](https://github.com/lesposito87/poorman-aws-playground/blob/main/root.hcl)).
